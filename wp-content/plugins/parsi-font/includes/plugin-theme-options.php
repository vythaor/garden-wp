<form method="post" action="options.php">
	...
	$mwfc_combine = $mwfc_fonts[$i].", ". $mwfc_latinfonts[$i];
   ?>
        <table class="form-table">
            ...
            <tr valign="top">
			   ...
			   for($i=0;$i<count($mwfc_fonts);$i++){?>
                  <option <?php echo ($options['hfontname'] == $mwfc_fonts[$i] ? "selected ":""); ?>value="<?= $mwfc_fonts[$i];?>"><?= $mwfc_fonts[$i];?></option>
			   <?php }?>
               </optgroup>
               <optgroup label="<?php _e('Latin Fonts', 'mwfc'); ?>">
			   <?php 
			   for($i=0;$i<count($mwfc_latinfonts);$i++){?>
                  <option <?php echo ($options['hfontname'] == $mwfc_latinfonts[$i] ? "selected ":""); ?>value="<?= $mwfc_latinfonts[$i];?>"><?= $mwfc_latinfonts[$i];?></option>
			   <?php }?>
               </optgroup>
			   ...
			   ?>
                  <option <?php echo ($options['hfontname'] == $mwfc_combine ? "selected ":""); ?>value="<?= $mwfc_fonts[$i];?>, <?= $mwfc_latinfonts[$j];?>"><?= $mwfc_fonts[$i];?>, <?= $mwfc_latinfonts[$j]; ?></option>
			   <?php } }?>
               </optgroup>
            </select>
                    <p class="description">
        ...
        <table class="form-table">
            ...
            <tr valign="top">
			   ...
			   <?php 
			   for($i=0;$i<count($mwfc_fonts);$i++){?>
                  <option <?php echo ($options['bodyfontname'] == $mwfc_fonts[$i] ? "selected ":""); ?>value="<?= $mwfc_fonts[$i];?>"><?= $mwfc_fonts[$i];?></option>
			   <?php }?>
               </optgroup>
               <optgroup label="<?php _e('Latin Fonts', 'mwfc'); ?>">
			   <?php 
			   for($i=0;$i<count($mwfc_latinfonts);$i++){?>
                  <option <?php echo ($options['bodyfontname'] == $mwfc_latinfonts[$i] ? "selected ":""); ?>value="<?= $mwfc_latinfonts[$i];?>"><?= $mwfc_latinfonts[$i];?></option>
			   <?php }?>
               </optgroup>
               <optgroup label="<?php _e('Fonts Combination', 'mwfc'); ?>">
			   <?php 
			   ...
			   <?php for($j=0;$j<count($mwfc_latinfonts);$j++){
					$mwfc_combine = $mwfc_fonts[$i].", ". $mwfc_latinfonts[$j];
			   ?>
                  <option <?php echo ($options['bodyfontname'] == $mwfc_combine ? "selected ":""); ?>value="<?= $mwfc_fonts[$i];?>, <?= $mwfc_latinfonts[$j];?>"><?= $mwfc_fonts[$i];?>, <?= $mwfc_latinfonts[$j]; ?></option>
			   <?php } }?>
               </optgroup>
            </select>
                    <p class="description">
        ...
        <table class="form-table">
            ...
            <tr valign="top">
			   ...
			   <?php 
			   for($i=0;$i<count($mwfc_fonts);$i++){?>
                  <option <?php echo ($options['adminfontname'] == $mwfc_fonts[$i] ? "selected ":""); ?>value="<?= $mwfc_fonts[$i];?>"><?= $mwfc_fonts[$i];?></option>
			   <?php }?>
               </optgroup>
               <optgroup label="<?php _e('Latin Fonts', 'mwfc'); ?>">
			   <?php 
			   for($i=0;$i<count($mwfc_latinfonts);$i++){?>
                  <option <?php echo ($options['adminfontname'] == $mwfc_latinfonts[$i] ? "selected ":""); ?>value="<?= $mwfc_latinfonts[$i];?>"><?= $mwfc_latinfonts[$i];?></option>
			   <?php }?>
               </optgroup>
               <optgroup label="<?php _e('Fonts Combination', 'mwfc'); ?>">
			   <?php 
			   ...
			   <?php for($j=0;$j<count($mwfc_latinfonts);$j++){
					$mwfc_combine = $mwfc_fonts[$i].", ". $mwfc_latinfonts[$j];
			   ?>
                  <option <?php echo ($options['adminfontname'] == $mwfc_combine ? "selected ":""); ?>value="<?= $mwfc_fonts[$i];?>, <?= $mwfc_latinfonts[$j];?>"><?= $mwfc_fonts[$i];?>, <?= $mwfc_latinfonts[$j]; ?></option>
			   <?php } }?>
               </optgroup>
            </select>
                    <p class="description">
        ...
        <table class="form-table">
            ...
            <tr valign="top">
			   ...
			   <?php 
			   for($i=0;$i<count($mwfc_fonts);$i++){?>
                  <option <?php echo ($options['c1fontname'] == $mwfc_fonts[$i] ? "selected ":""); ?>value="<?= $mwfc_fonts[$i];?>"><?= $mwfc_fonts[$i];?></option>
			   <?php }?>
               </optgroup>
               <optgroup label="<?php _e('Latin Fonts', 'mwfc'); ?>">
			   <?php 
			   for($i=0;$i<count($mwfc_latinfonts);$i++){?>
                  <option <?php echo ($options['c1fontname'] == $mwfc_latinfonts[$i] ? "selected ":""); ?>value="<?= $mwfc_latinfonts[$i];?>"><?= $mwfc_latinfonts[$i];?></option>
			   <?php }?>
               </optgroup>
               <optgroup label="<?php _e('Fonts Combination', 'mwfc'); ?>">
			   <?php 
			   ...
			   <?php for($j=0;$j<count($mwfc_latinfonts);$j++){
					$mwfc_combine = $mwfc_fonts[$i].", ". $mwfc_latinfonts[$j];
			   ?>
                  <option <?php echo ($options['c1fontname'] == $mwfc_combine ? "selected ":""); ?>value="<?= $mwfc_fonts[$i];?>, <?= $mwfc_latinfonts[$j];?>"><?= $mwfc_fonts[$i];?>, <?= $mwfc_latinfonts[$j]; ?></option>
			   <?php } }?>
               </optgroup>
            </select>
                    <p class="description">
            ...
            <tr valign="top">
               ...
               <option value=""><?php _e('None', 'mwfc'); ?></option>
               <?php for($i=5;$i<61;$i++){ ?>
               <option <?php echo ($options['c1fontsize'] == $i ? "selected ":""); ?>value="<?php echo $i;?>"><?php echo $i;?></option>
			   <?php } ?>
            </select>
                    <p class="description">
        ...
        <table class="form-table">
            ...
            <tr valign="top">
			   ...
			   <?php 
			   for($i=0;$i<count($mwfc_fonts);$i++){?>
                  <option <?php echo ($options['c2fontname'] == $mwfc_fonts[$i] ? "selected ":""); ?>value="<?= $mwfc_fonts[$i];?>"><?= $mwfc_fonts[$i];?></option>
			   <?php }?>
               </optgroup>
               <optgroup label="<?php _e('Latin Fonts', 'mwfc'); ?>">
			   <?php 
			   for($i=0;$i<count($mwfc_latinfonts);$i++){?>
                  <option <?php echo ($options['c2fontname'] == $mwfc_latinfonts[$i] ? "selected ":""); ?>value="<?= $mwfc_latinfonts[$i];?>"><?= $mwfc_latinfonts[$i];?></option>
			   <?php }?>
               </optgroup>
               <optgroup label="<?php _e('Fonts Combination', 'mwfc'); ?>">
			   <?php 
			   ...
			   <?php for($j=0;$j<count($mwfc_latinfonts);$j++){
					$mwfc_combine = $mwfc_fonts[$i].", ". $mwfc_latinfonts[$j];
			   ?>
                  <option <?php echo ($options['c2fontname'] == $mwfc_combine ? "selected ":""); ?>value="<?= $mwfc_fonts[$i];?>, <?= $mwfc_latinfonts[$j];?>"><?= $mwfc_fonts[$i];?>, <?= $mwfc_latinfonts[$j]; ?></option>
			   <?php } }?>
               </optgroup>
            </select>
                    <p class="description">
            ...
            <tr valign="top">
               ...
               <option value=""><?php _e('None', 'mwfc'); ?></option>
               <?php for($i=5;$i<61;$i++){ ?>
               <option <?php echo ($options['c2fontsize'] == $i ? "selected ":""); ?>value="<?php echo $i;?>"><?php echo $i;?></option>
			   <?php } ?>
            </select>
                    <p class="description">
                        <?php _e('Please select font size.', 'mwfc'); ?>
        ...
        <table class="form-table">
            ...
            <tr valign="top">
			   ...
			   <?php 
			   for($i=0;$i<count($mwfc_fonts);$i++){?>
                  <option <?php echo ($options['c3fontname'] == $mwfc_fonts[$i] ? "selected ":""); ?>value="<?= $mwfc_fonts[$i];?>"><?= $mwfc_fonts[$i];?></option>
			   <?php }?>
               </optgroup>
               <optgroup label="<?php _e('Latin Fonts', 'mwfc'); ?>">
			   <?php 
			   for($i=0;$i<count($mwfc_latinfonts);$i++){?>
                  <option <?php echo ($options['c3fontname'] == $mwfc_latinfonts[$i] ? "selected ":""); ?>value="<?= $mwfc_latinfonts[$i];?>"><?= $mwfc_latinfonts[$i];?></option>
			   <?php }?>
               </optgroup>
               <optgroup label="<?php _e('Fonts Combination', 'mwfc'); ?>">
			   <?php 
			   ...
			   <?php for($j=0;$j<count($mwfc_latinfonts);$j++){
					$mwfc_combine = $mwfc_fonts[$i].", ". $mwfc_latinfonts[$j];
			   ?>
                  <option <?php echo ($options['c3fontname'] == $mwfc_combine ? "selected ":""); ?>value="<?= $mwfc_fonts[$i];?>, <?= $mwfc_latinfonts[$j];?>"><?= $mwfc_fonts[$i];?>, <?= $mwfc_latinfonts[$j]; ?></option>
			   <?php } }?>
               </optgroup>
            </select>
                    <p class="description">
            ...
            <tr valign="top">
               ...
               <option value=""><?php _e('None', 'mwfc'); ?></option>
			   <?php for($i=5;$i<61;$i++){ ?>
               <option <?php echo ($options['c3fontsize'] == $i ? "selected ":""); ?>value="<?php echo $i;?>"><?php echo $i;?></option>
			   <?php } ?>
            </select>
                    <p class="description">
                        <?php _e('Please select font size.', 'mwfc'); ?>

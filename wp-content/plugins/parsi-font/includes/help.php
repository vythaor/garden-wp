...
<p>
    <?php _e('For using these fonts you must buy them from <a href="http://fontiran.com">FontIran</a>. After buying both fonts (or one of them), please follow these steps:', 'mwfc'); ?></p>
<p>
    <ol class="mwfcsteps" type="1">
        <li>
            <?php _e('Open zip file you downloaded from your <a href="http://fontiran.com">FontIran</a> panel and extract it.', 'mwfc'); ?></li>
        <li>
